/* Muestra mensaje de bienvenida al cargar la página */
function bienvenida() {
...
const contenidoExtra = document.getElementById('contenidoExtra');
 ...
 /* Al hacer clic, actualiza el contenido del párrafo */
...
/* Muestra y oculta la seccion de contenido extra al hacer clic en el botón */
